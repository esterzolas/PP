...
int main()
{
    ...
    for (i = 0; i < 5; i++)
    {
        printf("Digite o nome da receita %d:\n", i + 1);
        fgets(recepie[i].nome, 25, stdin);
        fflush(stdin);
        printf("Digite a quantidade de ingredientes que tem na receita %d:\n", i + 1);
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        {
            printf("Digite o(s) nome(s) do(s) ingrediente(s) da receita %d: \n" , i + 1);
            fgets(recepie[i].ing[j].nome, 15, stdin);
            fflush(stdin);
            printf("Digite a quantidade de ingrediente(s) existentes na receita %d: \n", j + 1);
    ...
    do
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            if (l == 0)
            {
                printf("Ingredientes que tem na receita %d: \n", i + 1);
                for (j = 0; j < quantING[i]; j++)
                {
